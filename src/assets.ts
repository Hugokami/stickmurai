...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    ultOmniName: "Omnislash", ultOmniDesc: "Execute lightning-fast cross-cuts (16 DMG) on all active enemies. Final blast deals 20 DMG and heals 2 Hearts.",
  ...
  ja: {
    ...
    ultOmniName: "超究武神覇斬", ultOmniDesc: "全敵へ神速の交差斬り（16 DMG）を放つ。最後の爆発で全敵に20ダメージを与えハートを2回復。",
