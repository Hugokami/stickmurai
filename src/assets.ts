...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    skillDecoyName: "Shadow Step / Decoy", skillDecoyDesc: "Tier VI (35,000 🔮): 5s stealth with +40% speed. Summons 3 shadow clones (150% taunt) that explode on death for 35 AoE DMG + 2.5s stun. Cooldown 12s.",
    btnDecoy: "SHADOW",
