...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    skillDecoyName: "Void Rupture: Phantom Slicer", skillDecoyDesc: "Tier VI (35,000 🔮): Instant 5-hit supersonic dimensional strike (80 DMG + 60 posture break). For 6s, all slashes unleash auto-homing phantom blades. Cooldown 10s.",
    btnDecoy: "RUPTURE",
    puRaijinSplitterName: "Raijin's Heaven-Splitter", puRaijinSplitterDesc: "Perfect parries strike down celestial violet thunderbolts (35 posture DMG) chaining shock damage to up to 4 nearby enemies.",
    puArterialGushName: "Arterial Gush", puArterialGushDesc: "Critical strikes rupture arteries, spraying blood arcs and inflicting Hemorrhage (enemies bleed 20% missing HP over 4s).",
    puSonicBreakName: "Sonic Breakthrough", puSonicBreakDesc: "Attacking out of a dash releases a supersonic shockwave that slices through enemy projectiles and extends blade reach by +100px.",
    puMiasmaCleaveName: "Miasma Cleave", puMiasmaCleaveDesc: "Sword swings leave a corrosive green toxic trail for 2.5s that dissolves enemy armor, increasing slash damage taken by +35%.",
    puHanabiBladeName: "Hanabi Blade", puHanabiBladeDesc: "Deflecting enemy projectiles unleashes a festive radial firework shrapnel blast, dealing 18 DMG and launching nearby foes airborne.",
    puGrimHarvestName: "Grim Harvest: Soul Rend", puGrimHarvestDesc: "Executing an elite or boss summons an ascending death specter that homes into the highest-HP foe, dealing 50% executed max HP as true DMG.",
  ...
  ja: {
    ...
    skillDecoyName: "虚空断絶・幻影裂斬（ヴォイド・ラプチャー）", skillDecoyDesc: "第6階位 (35,000 🔮): 超次元瞬歩で敵陣を一刀両断（80ダメ＋体幹60削り）。6秒間、通常斬撃が自動追尾の幻影刃を3連射出。CD 10秒。",
    skillGravityName: "神罰天雷・雷神壊滅（ライジン・カタクリズム）", skillGravityDesc: "頂点奥義 (50,000 🔮): 天裂く神雷が画面内の全敵弾を消滅させ、体幹120削り＋90範囲ダメ！7秒間、斬撃が最大5体に連鎖雷撃を放つ。CD 10秒。",
    btnShield: "風神",
    btnFlash: "雷神",
    btnFirewheel: "業火",
    btnGravity: "天雷",
    btnParryMaster: "弾き",
    btnDecoy: "虚空",
    puRaijinSplitterName: "雷神の天裂き", puRaijinSplitterDesc: "完璧な弾き成功時、天空より紫雷を落とし体幹35を粉砕。周囲の敵4体に連鎖雷撃。",
    puArterialGushName: "動脈崩壊（アーテリアル・ガッシュ）", puArterialGushDesc: "会心攻撃時に血飛沫が噴き出し重度出血を付与。敵は4秒間で減少体力の20%分のダメージを受ける。",
    puSonicBreakName: "音速突破（ソニック・ブレイク）", puSonicBreakDesc: "ダッシュ直後の斬撃が超音速衝撃波を形成。敵弾を両断消滅させ、刀の射程を+100px拡大。",
    puMiasmaCleaveName: "瘴気斬裂（ミアズマ・クリーブ）", puMiasmaCleaveDesc: "剣閃の軌道に2.5秒間腐食性の毒霧を展開。霧に触れた敵の装甲を融解させ被斬撃ダメ+35%。",
    puHanabiBladeName: "花火の刃（ハナビ・ブレード）", puHanabiBladeDesc: "敵弾を弾き返した瞬間、放射状の花火破片が炸裂。周囲の敵に18ダメ＋上空へ打ち上げ。",
    puGrimHarvestName: "魂刈りの死霊（グリム・ハーベスト）", puGrimHarvestDesc: "精鋭またはボスの処刑時、昇天する死霊を召喚。最大HPが最も高い敵へ自動突進し、処刑対象の最大HP50%の確定ダメ。",
