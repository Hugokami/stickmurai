...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    puCataclysmSuperconductorName: "Chain Superconductor", puCataclysmSuperconductorDesc: "Raijin's Cataclysm lightning arcs chain to +3 extra targets with +50% chain damage & 0.4s stun",
    puCataclysmThunderclapName: "Wrath of Raijin", puCataclysmThunderclapDesc: "Raijin's Cataclysm impact radius +50%, posture shred +40, and electrifies arena ground for 5s",
    puCataclysmConduitName: "Divine Conduit", puCataclysmConduitDesc: "While Raijin's Cataclysm is active, slashes restore +8 Flow and generate bonus lightning power",
    puRuptureSeveranceName: "Dimensional Severance", puRuptureSeveranceDesc: "Void Rupture dash width +60% and leaves a tearing void rift that pulls foes and slashes them for 4s",
    puRupturePhantomLegionName: "Phantom Legion", puRupturePhantomLegionDesc: "Void Rupture launches 5 piercing phantom blades on every slash instead of 3",
    puRupturePhaseStrikeName: "Spatial Warp Strike", puRupturePhaseStrikeDesc: "Dashing grants +0.4s i-frames and unleashes a radial dimensional cross-slash (45 + 200% ATK)",
    puChargeSpeedName: "Lightning Draw", puChargeSpeedDesc: "Iaijutsu charge speed +40%, wave damage +25, and wave width +35%",
    puDeflectDmgName: "Kinetic Rebound", puDeflectDmgDesc: "Deflected bullets pierce enemies with +150% speed, dealing 30 + 200% ATK and restoring +8 Flow",
    puVampireName: "Soul Tithe", puVampireDesc: "Every 15 enemy kills or every Manga Execution restores +1 Heart and unleashes a blood shockwave",
    puDimensionalName: "Dimensional Wave", puDimensionalDesc: "Iaijutsu range +45% and leaves an aftershock dimensional cut dealing 50 + 200% ATK",
    ...
    puTempoMasteryName: "Tempo Mastery", puTempoMasteryDesc: "Perfect parries & dodges grant Tempo Stacks (max 5). At 5 stacks, enter Tempo Flow for 8s: +40% attack speed, slashes ignore armor, perfect parries/dodges extend duration by 1s. Stacks decay at 1/s without perfect inputs.",
    ...
    puAttackPotionName: "Slash Elixir", puAttackPotionDesc: "Gain +5% ATK bonus for the current stage.",
    puExecutionDesc: "Unlock lethal cinematic Manga Executions on posture-broken foes, dealing massive lethal damage, blood splatters, and bonus Mon.",
    skillDecoyName: "Void Rupture: Phantom Slicer", skillDecoyDesc: "Tier VI (35,000 Mon): Instant 320px supersonic dimensional strike (110 + 950% ATK + 75 posture break). For 6s, enters void phase with afterimages and homing void blades (135% ATK). Cooldown 12s.",
    btnDecoy: "RUPTURE",
    puRaijinSplitterName: "Raijin's Heaven-Splitter", puRaijinSplitterDesc: "Perfect parries strike down celestial violet thunderbolts (45 + 350% ATK) chaining shock damage to up to 4 nearby enemies.",
    puArterialGushName: "Arterial Gush", puArterialGushDesc: "Critical strikes rupture arteries, spraying blood arcs and inflicting Hemorrhage (20% missing HP + 125% ATK over 4s).",
    puSonicBreakName: "Sonic Breakthrough", puSonicBreakDesc: "Attacking out of a dash releases a supersonic shockwave (180% ATK + 25) that slices through enemy projectiles and extends blade reach by +100px.",
    puMiasmaCleaveName: "Miasma Cleave", puMiasmaCleaveDesc: "Sword swings leave a corrosive toxic trail (15 + 80% ATK/s) that dissolves armor (+35% damage taken).",
    puHanabiBladeName: "Hanabi Blade", puHanabiBladeDesc: "Deflecting enemy projectiles unleashes a festive radial firework shrapnel blast (20 + 110% ATK) and airborne launch.",
    puGrimHarvestName: "Grim Harvest: Spectral Reaping", puGrimHarvestDesc: "Kills & posture breaks harvest Spectral Souls (max 3). At 3 souls, your 3rd combo slash or Iaijutsu unleashes a 270° Death Cleave (320% ATK, executes mobs ≤30% HP, carves 8% Boss HP).",
    ...
    skillEnhanceName: "Dragon's Fury", skillEnhanceDesc: "Tier I (0 Mon): Blade size +80%, +3 Flat DMG, and sword swings unleash piercing purple crescent dragon waves (100% ATK). Iaijutsu fires twin blazing dragons (300% ATK). Duration 10s. Cooldown 12s.",
    skillShieldName: "Wind Aegis", skillShieldDesc: "Tier III (7,500 Mon): 4.5s tempest barrier. Deflects enemy projectiles at 3x speed, pulsing every 0.6s for 18 + 220% ATK with vacuum pull. Cooldown 10s.",
    skillDashName: "Raijin Step", skillDashDesc: "Tier II (5,000 Mon): Ultra-snappy lightning hyper-dash (0.9s CD, 0.45s invuln). Slashes through enemies for 20 + 150% ATK and 1.2s stun with twin sky strikes.",
    skillFirewheelName: "Inferno Sweep", skillFirewheelDesc: "Tier V (12,500 Mon): 6.0s spinning blade ring dealing continuous burn damage (2 + 24% ATK every 0.25s) & fires 4 rotating fire projectiles every 0.45s (80% ATK). Ends in a 300px Inferno Supernova (250% ATK + burn). Cooldown 11s.",
    skillGravityName: "Heavenly Judgement: Raijin's Cataclysm", skillGravityDesc: "Apex Tier (50,000 Mon): Obliterates ALL on-screen enemy projectiles on cast! Calls down a 550px celestial thunderbolt dealing 140 + 1250% ATK + 120 posture break and 0.75s stun. Slashes chain violet lightning to 5 enemies (250% ATK) for 7s. Cooldown 10s.",
    skillParryMasterName: "Parry Master", skillParryMasterDesc: "Tier IV (10,000 Mon): 4.0s golden focus stance with +50% parry window. Riposte deals guaranteed 2.5x critical damage, breaks 40 enemy posture & grants +15 Flow. Cooldown 9s.",
    btnShield: "AEGIS",
    btnFlash: "RAIJIN",
    btnFirewheel: "SWEEP",
  ...
  ja: {
    ...
    puFirewheelRangeName: "灼熱の輪", puFirewheelRangeDesc: "業火の回天の攻撃範囲 +25%",
    ...
    puCataclysmSuperconductorName: "超伝導連鎖", puCataclysmSuperconductorDesc: "雷神壊滅の連鎖雷撃が+3体の敵へ波及（計8体）、連鎖ダメ+50%＆0.4秒スタン付与",
    puCataclysmThunderclapName: "雷神の怒号", puCataclysmThunderclapDesc: "雷神壊滅の着弾範囲+50%、体幹削り+40、さらに5秒間大地を帯電させランダムな敵を追撃",
    puCataclysmConduitName: "神罰の導線", puCataclysmConduitDesc: "雷神壊滅の雷撃強化中、通常斬撃ごとに気力+8回復＆追加の雷撃パワーを生成",
    puRuptureSeveranceName: "次元断層", puRuptureSeveranceDesc: "幻影裂斬の突進横幅+60%、さらに敵を引き寄せ斬り刻む虚空の裂け目を4秒間残す",
    puRupturePhantomLegionName: "百鬼幻刃", puRupturePhantomLegionDesc: "幻影裂斬の斬撃時、射出される貫通幻影刃が3本から5本に増加",
    puRupturePhaseStrikeName: "位相瞬斬", puRupturePhaseStrikeDesc: "ダッシュ中に無敵時間+0.4秒。終了地点で全方位次元十字斬（45＋斬撃力200%ダメ）を発動",
    puChargeSpeedName: "迅雷の構え", puChargeSpeedDesc: "居合チャージ速度+40%、真空波威力+25、真空波の幅+35%",
    puDeflectDmgName: "運動エネルギー反発", puDeflectDmgDesc: "跳ね返し弾の弾速+150%、敵を貫通し30＋斬撃力200%ダメ＆気力+8回復",
    puVampireName: "魂の貢ぎ物", puVampireDesc: "敵15体撃破ごと、または処刑発動時にハート+1回復＆吸血衝撃波を放出",
    puDimensionalName: "次元波動", puDimensionalDesc: "居合射程+45%、さらに0.3秒後に50＋斬撃力200%ダメの余波爆発を誘発",
    ...
    puAttackPotionName: "斬撃の秘薬", puAttackPotionDesc: "現在のステージ中、斬撃ダメージ+5%を獲得。",
    puExecutionName: "処刑の極意", puExecutionDesc: "体勢崩壊した敵に対する漫画風の一刀両断・処刑を発動可能にする。致命的なダメージ、血飛沫、ボーナス文を獲得。",
    selectSkillTitle: "アクティブスキルの選択",
    skillEnhanceName: "竜気解放（ドラゴンス・フューリー）", skillEnhanceDesc: "基本型 (0 文): 刀身+80%、斬撃固定値+3。通常斬撃で貫通紫電三日月波（斬撃力100%）を放ち、居合斬りで双頭紅蓮龍（斬撃力300%）を射出。持続10秒。CD 12秒。",
    skillDashName: "雷神ステップ（ライジン・ステップ）", skillDashDesc: "第2階位 (5,000 文): 超高速雷撃瞬歩（CD 0.9秒、完全無敵0.45秒）。敵陣を斬り裂き20＋斬撃力150%ダメージ＋1.2秒気絶を与え天雷を落とす。",
    skillShieldName: "風神の加護（ウィンド・アイギス）", skillShieldDesc: "第3階位 (7,500 文): 4.5秒間の暴風障壁。敵弾を3倍速で反射。0.6秒ごとに18＋斬撃力220%範囲ダメージと敵引き寄せ。CD 10秒。",
    skillParryMasterName: "弾きの極意（パリー・マスター）", skillParryMasterDesc: "第4階位 (10,000 文): 4.0秒間パリィ判定+50%。カウンターで2.5倍会心ダメージ、敵体幹を40削り気を+15回復。CD 9秒。",
    skillFirewheelName: "業火回天（インフェルノ・スウィープ）", skillFirewheelDesc: "第5階位 (12,500 文): 6.0秒間、半径260pxの灼熱輪（0.25秒毎に2＋斬撃力24%ダメ＋炎上）と4方向回転火球（斬撃力80%）。終了時に半径300pxの業火大爆発（斬撃力250%）。CD 11秒。",
    skillDecoyName: "虚空断絶・幻影裂斬（ヴォイド・ラプチャー）", skillDecoyDesc: "第6階位 (35,000 文): 320pxの超次元瞬歩で敵陣を一刀両断（110＋斬撃力950%ダメ＋体幹75削り＋0.7秒気絶）。6秒間、虚空歩行に入り斬撃が自動追尾の幻影刃（斬撃力135%）を射出。CD 12秒。",
    skillGravityName: "神罰天雷・雷神壊滅（ライジン・カタクリズム）", skillGravityDesc: "頂点奥義 (50,000 文): 発動時に画面内の全敵弾を完全消滅！半径550pxの天裂く神雷が140＋斬撃力1250%範囲ダメ＋体幹120削り＋0.75秒気絶。7秒間、斬撃が最大5体に連鎖雷撃（斬撃力250%）。CD 10秒。",
    btnShield: "風神",
    btnFlash: "雷神",
    btnFirewheel: "業火",
    btnGravity: "天雷",
    ...
    puGrimHarvestName: "魂刈りの死霊（グリム・ハーベスト）", puGrimHarvestDesc: "敵撃破・体幹崩壊で死神の魂を獲得（最大3体）。魂3体で3連斬目または居合術が画面全域の死神大旋風【黄泉大斬】（320%ダメ・HP30%以下即死・ボスHP8%削り）を発動。",
