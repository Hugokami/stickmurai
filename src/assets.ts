...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    btnDecoy: "SHADOW",
    puCursedGlassName: "Curse of Glass Edge", puCursedGlassDesc: "☠ CURSE: Max HP capped to 1. All attacks deal +3 DMG & +50% slash size.",
    puCursedBloodName: "Curse of Blood Thirst", puCursedBloodDesc: "☠ CURSE: Bleed 1 HP every 45s. Slain enemies grant +50% Flow and life steal.",
    puCursedIronName: "Curse of Heavy Iron", puCursedIronDesc: "☠ CURSE: Move speed -20%. Slash size +80% and projectile deflect DMG +4.",
  ...
  ja: {
    ...
    btnDecoy: "影遁",
    puCursedGlassName: "ガラスの刃の呪い", puCursedGlassDesc: "☠ 呪い: 最大HPが1に固定。攻撃力+3 & 斬撃範囲+50%。",
    puCursedBloodName: "血の渇きの呪い", puCursedBloodDesc: "☠ 呪い: 45秒毎に1HP減少。撃破時の気力獲得+50% & 吸血効果。",
    puCursedIronName: "重鉄の呪縛", puCursedIronDesc: "☠ 呪い: 移動速度-20%。斬撃範囲+80% & 弾き返しダメージ+4。",
