...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    skillShieldName: "Wind Aegis", skillShieldDesc: "Deflects bullets, grants invulnerability & +40% speed for 3.5s, pulsing to deal 6 DMG and pull in enemies. Cooldown 12s.",
    ...
    skillFirewheelName: "Inferno Sweep", skillFirewheelDesc: "Spins fire ring dealing 5 DMG every 0.3s & fireballs for 5s, erupting in an 8 DMG flame blast. Cooldown 12s.",
    skillGravityName: "Gravity Well", skillGravityDesc: "Pulls in enemies, dealing 2 DMG every 0.3s, devouring enemy bullets. Implodes for 12 DMG. Cooldown 10s.",
    skillParryMasterName: "Parry Master", skillParryMasterDesc: "Allows you to parry enemy attacks automatically by pressing attack for 3s. Cooldown 10s.",
    btnShield: "AEGIS",
    btnFlash: "RAIJIN",
    btnFirewheel: "SWEEP",
    btnGravity: "GRAVITY",
  ...
  ja: {
    ...
    skillShieldName: "烈風 of 加護", skillShieldDesc: "3.5秒間、無敵＆速度+40%。敵の弾を反射する風の盾を展開し、周囲の敵を引き寄せ6ダメージ。クールダウン12秒。",
    skillDashName: "雷神の瞬歩", skillDashDesc: "3ダメージ＆1.8秒気絶の雷光突進。開始と終了時に縦の稲妻を召喚する。クールダウン2.8秒。",
    skillFirewheelName: "業火の回天", skillFirewheelDesc: "5秒間、0.3秒ごとに5ダメージを与え火の玉を射出。終了時に8ダメの業火爆裂を放つ。クールダウン12秒。",
    skillGravityName: "重力崩壊", skillGravityDesc: "敵を引き寄せて0.3秒ごとに2ダメージを与える特異点を生成。敵の弾を消滅させ、最後に12ダメの爆発を起こす。クールダウン10秒。",
    skillParryMasterName: "弾きの極意", skillParryMasterDesc: "3秒間、攻撃するだけで自動的にパリィが発動。クールダウン10秒。",
    btnShield: "加護",
    btnFlash: "瞬歩",
    btnFirewheel: "回天",
    btnGravity: "重力",
