...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    puGrimHarvestName: "Grim Harvest: Spectral Reaping", puGrimHarvestDesc: "Every 3 kills summons an orbiting spectral death scythe (max 4) dealing 40 + 180% Slash DMG & slicing enemy bullets. Slaying an elite or boss detonates all scythes into a massive screen-clearing vortex.",
  ...
  ja: {
    ...
    puGrimHarvestName: "魂刈りの死霊（グリム・ハーベスト）", puGrimHarvestDesc: "敵を3体討伐するごとに周囲を旋回する死神の大鎌（最大4本）を召喚（40＋斬撃力180%ダメ＆敵弾消滅）。精鋭やボス討伐時は全鎌が画面全域の死神大旋風となり炸裂。",
