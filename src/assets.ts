...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    skillDecoyName: "Void Rupture: Phantom Slicer", skillDecoyDesc: "Tier VI (35,000 🔮): Instant 320px supersonic dimensional strike (110 + 950% ATK + 75 posture break). For 6s, enters void phase with afterimages and homing void blades (135% ATK). Cooldown 12s.",
    btnDecoy: "RUPTURE",
    ...
    skillEnhanceName: "Dragon's Fury", skillEnhanceDesc: "Tier I (0 🔮): Blade size +80%, +3 Flat DMG, and sword swings unleash piercing purple crescent dragon waves (100% ATK). Iaijutsu fires twin blazing dragons (300% ATK). Duration 10s. Cooldown 12s.",
    skillShieldName: "Wind Aegis", skillShieldDesc: "Tier III (7,500 🔮): 4.5s tempest barrier. Deflects enemy projectiles at 3x speed, pulsing every 0.6s for 18 + 220% ATK with vacuum pull. Cooldown 10s.",
    skillDashName: "Raijin Step", skillDashDesc: "Tier II (5,000 🔮): Ultra-snappy lightning hyper-dash (0.9s CD, 0.45s invuln). Slashes through enemies for 20 + 150% ATK and 1.2s stun with twin sky strikes.",
    skillFirewheelName: "Inferno Sweep", skillFirewheelDesc: "Tier V (12,500 🔮): 6.0s spinning blade ring dealing continuous burn damage (2 + 24% ATK every 0.25s) & fires 4 rotating fire projectiles every 0.45s (80% ATK). Ends in a 300px Inferno Supernova (250% ATK + burn). Cooldown 11s.",
    skillGravityName: "Heavenly Judgement: Raijin's Cataclysm", skillGravityDesc: "Apex Tier (50,000 🔮): Obliterates ALL on-screen enemy projectiles on cast! Calls down a 550px celestial thunderbolt dealing 140 + 1250% ATK + 120 posture break and 0.75s stun. Slashes chain violet lightning to 5 enemies (250% ATK) for 7s. Cooldown 10s.",
    skillParryMasterName: "Parry Master", skillParryMasterDesc: "Tier IV (10,000 🔮): 4.0s golden focus stance with +50% parry window. Riposte deals guaranteed 2.5x critical damage, breaks 40 enemy posture & grants +15 Flow. Cooldown 9s.",
    btnShield: "AEGIS",
    btnFlash: "RAIJIN",
    btnFirewheel: "SWEEP",
  ...
  ja: {
    ...
    skillEnhanceName: "竜気解放（ドラゴンス・フューリー）", skillEnhanceDesc: "基本型 (0 🔮): 刀身+80%、斬撃固定値+3。通常斬撃で貫通紫電三日月波（斬撃力100%）を放ち、居合斬りで双頭紅蓮龍（斬撃力300%）を射出。持続10秒。CD 12秒。",
    skillDashName: "雷神ステップ（ライジン・ステップ）", skillDashDesc: "第2階位 (5,000 🔮): 超高速雷撃瞬歩（CD 0.9秒、完全無敵0.45秒）。敵陣を斬り裂き20＋斬撃力150%ダメージ＋1.2秒気絶を与え天雷を落とす。",
    skillShieldName: "風神の加護（ウィンド・アイギス）", skillShieldDesc: "第3階位 (7,500 🔮): 4.5秒間の暴風障壁。敵弾を3倍速で反射。0.6秒ごとに18＋斬撃力220%範囲ダメージと敵引き寄せ。CD 10秒。",
    skillParryMasterName: "弾きの極意（パリー・マスター）", skillParryMasterDesc: "第4階位 (10,000 🔮): 4.0秒間パリィ判定+50%。カウンターで2.5倍会心ダメージ、敵体幹を40削り気を+15回復。CD 9秒。",
    skillFirewheelName: "業火回天（インフェルノ・スウィープ）", skillFirewheelDesc: "第5階位 (12,500 🔮): 6.0秒間、半径260pxの灼熱輪（0.25秒毎に2＋斬撃力24%ダメ＋炎上）と4方向回転火球（斬撃力80%）。終了時に半径300pxの業火大爆発（斬撃力250%）。CD 11秒。",
    skillDecoyName: "虚空断絶・幻影裂斬（ヴォイド・ラプチャー）", skillDecoyDesc: "第6階位 (35,000 🔮): 320pxの超次元瞬歩で敵陣を一刀両断（110＋斬撃力950%ダメ＋体幹75削り＋0.7秒気絶）。6秒間、虚空歩行に入り斬撃が自動追尾の幻影刃（斬撃力135%）を射出。CD 12秒。",
    skillGravityName: "神罰天雷・雷神壊滅（ライジン・カタクリズム）", skillGravityDesc: "頂点奥義 (50,000 🔮): 発動時に画面内の全敵弾を完全消滅！半径550pxの天裂く神雷が140＋斬撃力1250%範囲ダメ＋体幹120削り＋0.75秒気絶。7秒間、斬撃が最大5体に連鎖雷撃（斬撃力250%）。CD 10秒。",
    btnShield: "風神",
    btnFlash: "雷神",
    btnFirewheel: "業火",
    btnGravity: "天雷",
