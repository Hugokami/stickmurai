...
export function playSynthesizedClash() {
  // Completely silenced per user instruction: removed posture break and blade clash audio
}
...
// Kick off instant audio autoplay & unlock handlers immediately upon module load
initImmediateAudio();
