...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    puCataclysmConduitName: "Divine Conduit", puCataclysmConduitDesc: "While Raijin's Cataclysm is active, slashes restore +5 Flow and extend buff duration by +0.6s",
  ...
  ja: {
    ...
    puCataclysmConduitName: "神罰の導線", puCataclysmConduitDesc: "雷神壊滅の雷撃強化中、通常斬撃ごとに気力+5回復＆効果時間が+0.6秒延長",
