...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    puRupturePhaseStrikeName: "Spatial Warp Strike", puRupturePhaseStrikeDesc: "Dashing grants +0.4s i-frames and unleashes a radial dimensional cross-slash (45 + 200% Slash DMG)",
    puChargeSpeedName: "Lightning Draw", puChargeSpeedDesc: "Iaijutsu charge speed +40%, wave damage +25, and wave width +35%",
    puDeflectDmgName: "Kinetic Rebound", puDeflectDmgDesc: "Deflected bullets pierce enemies with +150% speed, dealing 30 + 200% Slash DMG and restoring +8 Flow",
    ...
    puDimensionalName: "Dimensional Wave", puDimensionalDesc: "Iaijutsu range +45% and leaves an aftershock dimensional cut dealing 50 + 200% Slash DMG",
    ...
    puAttackPotionName: "Slash Elixir", puAttackPotionDesc: "Gain +5% Slash Damage bonus for the current stage.",
    ...
    skillDecoyName: "Void Rupture: Phantom Slicer", skillDecoyDesc: "Tier VI (35,000 🔮): Instant 320px supersonic dimensional strike (110 + 950% Slash DMG + 75 posture break). For 6s, enters void phase with afterimages and homing void blades (135% Slash DMG). Cooldown 12s.",
    btnDecoy: "RUPTURE",
    ...
    puGrimHarvestName: "Grim Harvest: Spectral Reaping", puGrimHarvestDesc: "Kills & posture breaks harvest Spectral Souls (max 3). At 3 souls, your 3rd combo slash or Iaijutsu unleashes a 270° Death Cleave (320% Slash DMG, executes mobs ≤30% HP, carves 8% Boss HP).",
    ...
    skillEnhanceName: "Dragon's Fury", skillEnhanceDesc: "Tier I (0 🔮): Blade size +80%, +3 Flat Slash DMG, and sword swings unleash piercing purple crescent dragon waves (100% Slash DMG). Iaijutsu fires twin blazing dragons (300% Slash DMG). Duration 10s. Cooldown 12s.",
    skillShieldName: "Wind Aegis", skillShieldDesc: "Tier III (7,500 🔮): 4.5s tempest barrier. Deflects enemy projectiles at 3x speed, pulsing every 0.6s for 18 + 220% Slash DMG with vacuum pull. Cooldown 10s.",
    skillDashName: "Raijin Step", skillDashDesc: "Tier II (5,000 🔮): Ultra-snappy lightning hyper-dash (0.9s CD, 0.45s invuln). Slashes through enemies for 20 + 150% Slash DMG and 1.2s stun with twin sky strikes.",
    skillFirewheelName: "Inferno Sweep", skillFirewheelDesc: "Tier V (12,500 🔮): 6.0s spinning blade ring dealing continuous burn damage (2 + 24% Slash DMG every 0.25s) & fires 4 rotating fire projectiles every 0.45s (80% Slash DMG). Ends in a 300px Inferno Supernova (250% Slash DMG + burn). Cooldown 11s.",
    skillGravityName: "Heavenly Judgement: Raijin's Cataclysm", skillGravityDesc: "Apex Tier (50,000 🔮): Obliterates ALL on-screen enemy projectiles on cast! Calls down a 550px celestial thunderbolt dealing 140 + 1250% Slash DMG + 120 posture break and 0.75s stun. Slashes chain violet lightning to 5 enemies (250% Slash DMG) for 7s. Cooldown 10s.",
