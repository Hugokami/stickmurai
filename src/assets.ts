...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    guideFlow: "<strong>Flow Awakening (Ultimates):</strong> Defeat enemies to fill the orange FLOW meter. When full, press <strong>F Key</strong> (or tap <strong>ULT</strong> on Mobile) to select and trigger a devastating Ultimate:<br>• <strong>Shadow Awakening:</strong> 10 seconds of god-speed. Basic attacks gain +4 DMG, spawn shadow clones that teleport and strike enemies for 4 DMG, and dash cooldown is reduced to 0.<br>• <strong>Omnislash:</strong> Freezes time for 3.5s, executing 3 cross-cuts dealing 16 DMG each to all enemies, followed by a final blast dealing 20 DMG to remaining enemies, restoring 2 Hearts.<br>• <strong>Wrath of the Storm God:</strong> 7 seconds of electric fury. Slashes fire chain-lightning to 4 targets. Dashes become instant teleports (450px) that strike start and destination coordinates with vertical lightning (10 DMG, 3s stun, chains to 5 targets for 4 DMG).",
    ...
    puDurationName: "Divine Scroll", puDurationDesc: "Enhance Duration +4s",
    ...
    btnDecoy: "SHADOW",
    ultShadowName: "Shadow Awakening", ultShadowDesc: "10s of god-speed. Slashes deal +4 DMG and spawn clones that teleport-strike enemies. Dash cooldown becomes 0.",
    ...
    ultStormName: "Wrath of the Storm God", ultStormDesc: "7s of thunder fury. Slashes fire chain lightning. Dashes teleport 450px and call lightning strikes (10 DMG, 3s stun).",
    playZen: "Zen Mode",
  ...
  ja: {
    ...
    guideFlow: "<strong>気の覚醒 (奥義):</strong> 敵を倒してオレンジ色の気（FLOW）ゲージを溜めます。満タン時に<strong>Fキー</strong>（モバイルでは<strong>奥義ボタン</strong>）を押すと、以下のいずれかの強力な奥義を選択・発動できます：<br>• <strong>影の覚醒:</strong> 10秒間の神速状態。通常攻撃のダメージが+4され、敵に瞬間移動して4ダメージを与える影分身を生成。ダッシュのクールダウンが0になります。<br>• <strong>超究武神覇斬:</strong> 3.5秒間時間を停止し、全敵に16ダメージの交差斬りを3回実行。最後に残った敵に20ダメージの爆風を放ち、ライフを2回復。<br>• <strong>雷神の稲妻:</strong> 7秒間の雷撃状態。通常斬撃から4体に連鎖する雷撃を放つ。さらにダッシュが瞬間移動（450px）になり、開始地点と終点に縦の稲妻（10ダメージ、3秒気絶、5体へ4ダメージの連鎖）を落とします。",
    ...
    puDurationName: "神の巻物", puDurationDesc: "強化持続時間 +4秒",
    ...
    btnDecoy: "影遁",
    ultShadowName: "影 of 覚醒", ultShadowDesc: "10秒間の神速移動状態。攻撃ダメージ+4かつ自動追撃の影分身を生成し、ダッシュのクールダウンを0にする。",
    ultOmniName: "超究武神覇斬", ultOmniDesc: "3.5秒間時間停止し、16ダメージの交差斬り3回。最後の爆発で全敵に20ダメージを与えハートを2回復。",
    ultStormName: "雷神の稲妻", ultStormDesc: "7秒間の雷撃状態。通常攻撃で連鎖雷撃。ダッシュは瞬間移動になり、開始点・終点に稲妻（10 DMG、3秒気絶）を召喚。",
    playZen: "禅・受け流し",
