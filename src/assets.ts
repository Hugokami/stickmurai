...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    ultStormName: "Wrath of the Storm God", ultStormDesc: "12s of thunder fury. Slashes fire chain lightning. Dashes teleport 450px and call lightning strikes (10 DMG, 3s stun).",
    playZen: "Zen Mode",
  ...
  ja: {
    ...
    ultStormName: "雷神の稲妻", ultStormDesc: "12秒間の雷撃状態。通常攻撃で連鎖雷撃。ダッシュは瞬間移動になり、開始点・終点に稲妻（10 DMG、3秒気絶）を召喚。",
    playZen: "禅・受け流し",
