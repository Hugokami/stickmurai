...
export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    guideChiburui: "<strong>Chiburui & Noto (血振るい):</strong> Stand completely still for 1.2s after 3+ kills. Cleanses blade, grants +15 Flow, and your next strike deals guaranteed 2.5x CRIT damage!",
    guideChiburuiText: "Stand completely still for 1.2s after 3+ kills. Cleanses blade, grants +15 Flow, and your next strike deals guaranteed 2.5x CRITICAL damage!",
    ...
    skillDecoyName: "Shadow Step / Decoy", skillDecoyDesc: "Tier VI (35,000 🔮): 5s stealth with +40% speed & guaranteed 3.0x ambush crit. Summons 3 shadow clones (150% taunt) that explode on death for 35 AoE DMG + 2.5s stun. Cooldown 12s.",
    btnDecoy: "SHADOW",
    ...
    skillGravityName: "Gravity Well", skillGravityDesc: "APEX Tier (50,000 🔮): Titanic 420px event horizon. Crushes bullets, vacuums all foes, deals 6 DMG every 0.25s (24 DPS), and implodes in a 50 AoE supernova! Cooldown 9s.",
  ...
  ja: {
    ...
    skillDecoyName: "影遁・幻影の術（シャドウ・ステップ）", skillDecoyDesc: "第6階位 (35,000 🔮): 5秒間完全ステルス＆速度+40%、次回攻撃3.0倍確定会心。挑発分身を3体召喚し、死亡時35範囲ダメ＋2.5秒気絶。CD 12秒。",
    skillGravityName: "重力崩壊（グラビティ・ウェル）", skillGravityDesc: "頂点奥義 (50,000 🔮): 半径420pxの超巨大事象の地平面！全敵弾を消滅させ敵を猛烈に吸引。秒間24ダメを与え最後に50ダメの超新星爆発！CD 9秒。",
    btnShield: "風神",
    btnFlash: "雷神",
    btnFirewheel: "業火",
    btnGravity: "重力",
...
export const skillsData = [
  ...
  { id: 'decoy_illusion', nameKey: 'skillDecoyName', descKey: 'skillDecoyDesc', cost: 17500, icon: '👤' },
  { id: 'gravity', nameKey: 'skillGravityName', descKey: 'skillGravityDesc', cost: 25000, icon: '🌀' }
];
